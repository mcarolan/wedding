 ...
 */ /*global window, document*/ (function(exports) {
    "use strict";
    var extend, createElements, createCountdownElt, simplyCountdown1;
    /**
     ...
     */ simplyCountdown1 = function(elt, args) {
        var parameters = extend({
            ...
            zeroPad: false
        }, args), interval, targetDate, targetTmpDate, now, nowUtc, secondsLeft, days, hours, minutes, seconds, cd = document.querySelectorAll(elt);
        ...
        if (parameters.enableUtc) targetDate = new Date(targetTmpDate.getUTCFullYear(), targetTmpDate.getUTCMonth(), targetTmpDate.getUTCDate(), targetTmpDate.getUTCHours(), targetTmpDate.getUTCMinutes(), targetTmpDate.getUTCSeconds());
        else targetDate = targetTmpDate;
...
/*global $, jQuery, simplyCountdown*/ if (window.jQuery) (function($, simplyCountdown1) {
    "use strict";
...
//# sourceMappingURL=index.520fecb9.js.map
