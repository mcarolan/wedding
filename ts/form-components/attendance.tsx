...
export function Attendance(props: FormComponentProps) {
    ...
    return <>
        ...
        <div className="radio-group" role="radiogroup" aria-labelledby={idFor("attendance-label", guest)}>
            <div>
                <input type="radio" checked={guest.attendance == true} onChange={changeAttendance} name={idFor("attendance-radio", guest)} value="true" id={idFor("able-to-attend", guest)} />
                <label htmlFor={idFor("able-to-attend", guest)}>I'd be delighted to attend ✅</label>
            </div>
            <div>
                <input type="radio" checked={guest.attendance == false} onChange={changeAttendance} name={idFor("attendance-radio", guest)} value="false" id={idFor("unable-to-attend", guest)} />
